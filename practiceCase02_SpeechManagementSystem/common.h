...
const vector<string> LastNames = { "Zhao", "Qian", "Sun", "Li",
                                  "Zhou", "Wu", "Zheng", "Wang",
                                  "Feng", "Chen", "Chu", "Wei",
                                  "He", "Lv", "Shi", "Zhang" };

const vector<string> MiddleNames = { "Ya", "Zi", "Xin", "Ting",
                                    "Xuan", "Jian", "Jie", "Xian",
                                    "Dong", "Hui", "Xu", "Yi",
                                    "De", "Bao", "Jun", "Guo" };
const vector<string> FirstNames = { "han", "mei", "heng", "feng",
                                    "long", "xiao", "liang", "hao",
                                    "ze", "ming", "jia", "run",
                                    "jiang", "fan", "yong", "na" };

// 共3465个
const vector<string> areaIds = { "110000", ///< "北京市",
                                "110100", ///< "北京市市辖区",
                                "110101", ///< "北京市东城区",
                                "110102", ///< "北京市西城区",
                                "110103", ///< "北京市崇文区",
